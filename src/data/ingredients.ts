...
export const ingredients: Ingredient[] = [
  ...
  { name: 'Soju', nameEN: 'Soju', category: 'Spiritueux' },
  ...
  { name: 'Disaronno', nameEN: 'Amaretto', category: 'Liqueurs' },
  ...
  { name: 'Vermouth blanc', nameEN: 'Bianco Vermouth', category: 'Vins & Vermouths' },
  { name: 'Lillet Blanc', nameEN: 'Lillet Blanc', category: 'Vins & Vermouths' },
  { name: 'Lillet Rouge', nameEN: 'Lillet Rouge', category: 'Vins & Vermouths' },
  ...
  { name: 'Sirop de gingembre', nameEN: 'Ginger syrup', category: 'Sirops & Sucres' },
  { name: 'Sirop de lavande', nameEN: 'Lavender syrup', category: 'Sirops & Sucres' },
  ...
  { name: 'Sprite', nameEN: 'Sprite', category: 'Sodas & Mixers' },
  { name: '7-Up', nameEN: '7-Up', category: 'Sodas & Mixers' },
  { name: 'Red Bull', nameEN: 'Red Bull', category: 'Sodas & Mixers' },
  { name: 'Schweppes', nameEN: 'Schweppes', category: 'Sodas & Mixers' },
  { name: 'Bière', nameEN: 'Beer', category: 'Sodas & Mixers' },
  { name: 'Cidre', nameEN: 'Cider', category: 'Sodas & Mixers' },
  { name: 'Eau', nameEN: 'Water', category: 'Sodas & Mixers' },
  { name: 'Eau chaude', nameEN: 'Hot Water', category: 'Sodas & Mixers' },
  ...
  { name: 'Yaourt', nameEN: 'Yoghurt', category: 'Produits laitiers' },

  // === FRUITS ===
  { name: 'Fraises', nameEN: 'Strawberries', category: 'Fruits' },
  { name: 'Framboises', nameEN: 'Raspberry', category: 'Fruits' },
  { name: 'Mûres', nameEN: 'Blackberry', category: 'Fruits' },
  { name: 'Myrtilles', nameEN: 'Blueberry', category: 'Fruits' },
  ...
  { name: 'Raisin', nameEN: 'Grape', category: 'Fruits' },
  { name: 'Kiwi', nameEN: 'Kiwi', category: 'Fruits' },
  { name: 'Litchi', nameEN: 'Lychee', category: 'Fruits' },
  { name: 'Concombre', nameEN: 'Cucumber', category: 'Fruits' },

  // === HERBES & ÉPICES ===
  { name: 'Menthe', nameEN: 'Mint', category: 'Herbes & Épices' },
  { name: 'Menthe fraîche', nameEN: 'Fresh mint', category: 'Herbes & Épices' },
  { name: 'Basilic', nameEN: 'Basil', category: 'Herbes & Épices' },
  { name: 'Romarin', nameEN: 'Rosemary', category: 'Herbes & Épices' },
  { name: 'Thym', nameEN: 'Thyme', category: 'Herbes & Épices' },
  { name: 'Lavande', nameEN: 'Lavender', category: 'Herbes & Épices' },
  ...
  { name: 'Clou de girofle', nameEN: 'Cloves', category: 'Herbes & Épices' },
  { name: 'Anis étoilé', nameEN: 'Star anise', category: 'Herbes & Épices' },
  { name: 'Vanille', nameEN: 'Vanilla', category: 'Herbes & Épices' },
  { name: 'Extrait de vanille', nameEN: 'Vanilla extract', category: 'Herbes & Épices' },
  { name: 'Poivre', nameEN: 'Pepper', category: 'Herbes & Épices' },
  { name: 'Piment', nameEN: 'Chili', category: 'Herbes & Épices' },
  { name: 'Jalapeño', nameEN: 'Jalapeno', category: 'Herbes & Épices' },
  { name: 'Céleri', nameEN: 'Celery', category: 'Herbes & Épices' },
  { name: 'Sel de céleri', nameEN: 'Celery salt', category: 'Herbes & Épices' },

  // === GARNITURES ===
  { name: 'Glace', nameEN: 'Ice', category: 'Garnitures' },
  { name: 'Glace pilée', nameEN: 'Crushed Ice', category: 'Garnitures' },
  ...
  { name: 'Sel', nameEN: 'Salt', category: 'Garnitures' },
  { name: 'Sucre pour bordure', nameEN: 'Sugar', category: 'Garnitures' },
  { name: 'Chocolat', nameEN: 'Chocolate', category: 'Garnitures' },
  { name: 'Cacao en poudre', nameEN: 'Cocoa powder', category: 'Garnitures' },
  { name: 'Grains de café', nameEN: 'Coffee', category: 'Garnitures' },
